...
other implementations can be asymptotically slower, and can sometimes
...
worst case, and O(N log K) time in the best case. In practice, other implementations can
