...
- Pre-print: https://arxiv.org/abs/2410.08654
- Published in [[https://www.mdpi.com/1999-4893/19/9/754][Algorithms, 2026]].
...
** Replication materials for Finite sample complexity analysis of binary segmentation
...
- Figure 3: number of candidate splits considered in real genomic
  ChIP-seq data from McGill benchmark. [[file:figure-mcgill-iterations-data.R][R code 1]] makes [[file:figure-mcgill-iterations-data.csv][CSV file]], [[file:figure-mcgill-iterations.R][R code 2]] makes [[file:figure-mcgill-iterations.png][PNG figure]].
- Figure 4: number of candidate splits considered in real genomic copy
  number data from neuroblastoma benchmark. [[file:figure-neuroblastoma-iterations-data.R][R code 1]] makes [[file:figure-neuroblastoma-iterations-data.csv][CSV file]], [[file:figure-neuroblastoma-iterations.R][R code 2]] makes [[file:figure-neuroblastoma-iterations.png][PNG figure]].
- Figure 5: seconds and splits. [[file:figure-splits-time-data.R][R code 1]] makes [[file:figure-splits-time-data.rds][RDS file]], [[file:figure-splits-time.R][R code 2]] makes [[file:figure-splits-time.pdf][PDF figure]].
- Figure 6: sbs and wbs timings. [[file:figure-wbs-sim-data.R][R code 1]] makes [[file:figure-wbs-sim-data.rds][RDS file]], [[file:figure-wbs.R][R code 2]] makes [[file:figure-wbs-sim-pred.png][PNG figure]].

** Paper in progress: Comparing binsegRcpp with other implementations of binary segmentation for change-point detection

[[file:article.pdf?raw=true][PDF submitted to JSS]].
...
should be extremely fast for N data and S segments: asymptotically O(N S) time in the
worst case, and O(N log S) time in the best case. In practice, existing implementations
can be asymptotically slower, and can return incorrect results. We propose binsegRcpp,
an R package which provides a correct C++ implementation, with the expected asymp-
totic time complexity. We discuss several important C++ coding techniques, and include
detailed comparisons with other implementations of binary segmentation: ruptures, fpop,
changepoint, blockcpd, and wbs.

Replication materials: [[file:article_replication.tgz][TGZ with data and R script for JSS]].

- Figure 1 (models from 2 to 4 segments) and manuscript code/output: source [[file:article.Rnw][article.Rnw]], [[file:article-ex6.pdf][PDF]].
- Figure 2 (DNA copy number example): [[file:changepoint.bug.R][R code]], [[file:changepoint.bug.png][PNG]].
- Figure 3 (cross-validation): [[file:article-two-changes.R][R code]], [[file:article-two-changes.pdf][PDF]].
- Figures 4-6 (list vs multiset, changepoint vs ruptures, throughput):
  [[file:figure-heap-data.R][R timing code]], [[file:figure-heap.R][R figure code]], [[file:figure-heap-refs-binsegRcpp.png][Figure 4 PNG]], [[file:figure-heap-refs-binsegRcpp.tex][Figure 4 tex]], [[file:figure-heap-refs-other.png][Figure 5 PNG]], [[file:figure-heap-refs-binsegRcpp.tex][Figure 5 tex]], [[file:figure-heap-pred.png][Figure 6 PNG]].
- Figure 7 (square loss): [[file:figure-timings-data.R][R timing code]], [[file:figure-timings.R][R figure code]], [[file:figure-timings.png][PNG]].
- Figure 8 (normal change in mean and variance): [[file:figure-timings-meanvar_norm-data.R][R timing code]], [[file:figure-timings-meanvar_norm.R][R figure code]], [[file:figure-timings-meanvar_norm.png][PNG]].
- Figure 9 (Poisson): [[file:figure-timings-poisson-data.R][R timing code]], [[file:figure-timings-poisson.R][R figure code]], [[file:figure-timings-poisson.png][PNG]].
- Figure 10 (L1): [[file:figure-timings-laplace-data.R][R timing code]], [[file:figure-timings-laplace.R][R figure code]], [[file:figure-timings-laplace.png][PNG]].
- Figure 11 (compare distributions): [[file:figure-compare-distributions.R][R figure code]], [[file:figure-compare-distributions.png][PNG]].
...
[[file:figure-splits-time-data.R]] makes [[file:figure-splits-time-data.rds]]

[[file:figure-splits-time.R]] makes

[[file:figure-splits-time.png]]

[[file:figure-splits-time.tex]]

[[file:figure-splits-time.pdf]]

[[file:figure-wbs-data.R]] makes [[file:figure-wbs-data.R]]

[[file:figure-wbs-sim-data.R]] makes [[file:figure-wbs-sim-data.rds]]

[[file:figure-wbs.R]] makes

[[file:figure-wbs-sim-nb.png]]

[[file:figure-wbs-sim-ref.png]]

[[file:figure-wbs-sim-pred.png]]
