...
\begin{figure}[H]
    %\centering
  \hspace{-12pt}  \includegraphics[width=\textwidth]{figure-optimal-trees-some.png}
 \vspace{-6pt}
...
\begin{figure}[H]
    %\centering
 \hspace{-7pt}   \includegraphics[width=\textwidth]{figure-splits-time.pdf}
    %\vspace{-0.7cm}
...
\paragraph{Author contributions.} All authors have read and agreed to the published version of the manuscript.
% TODO
